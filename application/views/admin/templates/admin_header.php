...
<head>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?php echo base_url();?>assets/template/plugins/overlayScrollbars/css/OverlayScrollbars.css">
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">template/
            ...
            <div class="modal-dialog modal-sm" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a class="btn btn-success btn-sm" href="<?php echo site_url('administrador/auth/logout'); ?>">Inicio de Sesion</a>
                </div>
